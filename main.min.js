        ...
        (function(o, i) {
            ! function(e, o) {
                ...
                var Y = Math.random().toString(36).substring(2),
                    ...
                    Z = function() {
                        function e(t) {
                            this[Y] = R(), this._result = this._state = void 0, this._subscribers = [], l !== t && ("function" != typeof t && k(), this instanceof e ? S(this, t) : x())
                        }
                ...
                return i(e, [{
                    ...
                    value: function() {
                        ...
                        var r = document.getElementById("gdsdk__pauseGame"),
                            ...
                            l = document.getElementById("gdsdk__midrollTimer"),
                            u = document.getElementById("gdsdk__hbgdDebug"),
        ...
        var i = function() {
            ...
            c = function() {
                function e(t, n, i) {
                    ...
                    this.options = i ? (0, s.extendDefaults)(c, i) : c, this.prefix = "gdsdk__", this.adsLoader = null, this.adsManager = null, this.adDisplayContainer = null, this.eventBus = new r.default, this.safetyTimer = null, this.containerTransitionSpeed = 300, this.adCount = 0, this.adTypeCount = 0, this.requestRunning = !1, this.parentDomain = (0, s.getParentDomain)(), this.parentUrl = (0, s.getParentUrl)(), this.userDeclinedPersonalAds = document.location.search.indexOf("gdpr-targeting=0") >= 0 || document.cookie.indexOf("ogdpr_advertisement=0") >= 0 ? "1" : "0", this.thirdPartyContainer = "" !== t ? document.getElementById(t) : null, this.options.width = "number" == typeof this.options.width ? this.options.width : "100%" === this.options.width ? 640 : this.options.width.replace(/[^0-9]/g, ""), this.options.height = "number" == typeof this.options.height ? this.options.height : "100%" === this.options.height ? 360 : this.options.height.replace(/[^0-9]/g, "");
                    ...
                    value: function() {
                        ...
                        return new Promise(function(t) {
                            ...
                            var o = (0, s.getMobilePlatform)(),
                                ...
                                d = r ? "&ch=" + r : "",
                                c = a ? "&ch_date=" + a : "",
                                l = "https://pub.tunnl.com/opphb?" + n + "&player_width=" + e.options.width + "&player_height=" + e.options.height + "&ad_type=video_image&os=" + o + "&game_id=" + e.gameId + "&ad_position=" + i + d + c + "&correlator=" + Date.now(),
                                u = new Request(l, {
                                    method: "GET"
                                });
        ...
        var a = o(e("../package.json")),
            ...
            p = function() {
                function e(t) {
                    ...
                    if (this._analytics(f, p), ["razda.com", "174.127.72.247"].indexOf(p) > -1) return void 0 !== window.ga && window.ga("gd.send", {
                        hitType: "event",
                        eventCategory: "SDK_BLOCKED",
                        eventAction: p,
                        eventLabel: this.options.gameId + ""
                    }), void(document.location = "https://html5.api.gamedistribution.com/blocked.html?domain=" + p);
                    var m = [];
                    ...
                    var y = new Promise(function(e) {
                        var t = {
                            ...
                            o = "https://game.api.gamedistribution.com/game/get/" + t.gameId.replace(/-/g, "") + "/?domain=" + p,
                            i = new Request(o, {
                                method: "GET"
                            });
                        fetch(i).then(function(e) {
                            ...
                            if (n.error)(0, u.dankLog)("SDK_GAME_DATA_READY", n.error, "warning");
                            else if (n.success) {
                                var o = {
                                    gameId: n.result.game.gameMd5,
                                    advertisements: n.result.game.enableAds,
                                    preroll: n.result.game.preRoll,
                                    midroll: 6e4 * n.result.game.timeAds,
                                    title: n.result.game.title,
                                    tags: n.result.game.tags,
                                    category: n.result.game.category,
                                    assets: n.result.game.assets
                                };
                                t = (0, h.extendDefaults)(t, o);
                                var i = ["patiencespel.net", "mahjongspielen.at", "mahjongspel.co"];
                                ["y8.com", "pog.com", "dollmania.com"].indexOf(p) > -1 ? t.midroll = 3e5 : i.indexOf(p) > -1 && (t.midroll = 6e4), (0, u.dankLog)("SDK_GAME_DATA_READY", t, "success")
                            }
                            e(t)
                        }).catch(function(n) {
                ...
                return s(e, [{
                    ...
                    value: function(e) {
                        ...
                        var c = document.location.search.indexOf("gdpr-third-party") >= 0,
                            l = document.location.search.indexOf("gdpr-third-party=1") >= 0,
                            u = "",
                            h = "";
                    ...
                    value: function(e, t) {
                        ...
                        (0, h.getScript)("https://www.google-analytics.com/analytics.js", "gdsdk_google_analytics").then(function() {
                            ...
                            n.readyPromise.then(function(e) {
                                "object" === r(window._cc13998) && "function" == typeof window._cc13998.bcpf && "function" == typeof window._cc13998.bcpw && (window._cc13998.bcpw("act", "play"), window._cc13998.bcpw("genp", t), window._cc13998.bcpw("int", "category : " + e.category.toLowerCase()), "complete" === document.readyState ? window._cc13998.bcpf() : window._cc13998.bcp())
                            })
                        }).catch(function(e) {
                            (0, u.dankLog)("SDK_LOAD_SCRIPT", e, "error")
                        })
                    ...
                    value: function() {
                        ...
                        this.readyPromise.then(function(t) {
                            t.advertisements && !e.whitelabelPartner ? void 0 !== e.adRequestTimer ? (new Date).valueOf() - e.adRequestTimer.valueOf() < t.midroll ? ((0, u.dankLog)("SDK_SHOW_BANNER", "The advertisement was requested too soon after the previous advertisement was finished.", "warning"), e.onResumeGame("Just resume the game...", "success")) : ((0, u.dankLog)("SDK_SHOW_BANNER", "Requested the midroll advertisement.", "success"), e.adRequestTimer = new Date, e.videoAdInstance.requestAttempts = 0, e.videoAdInstance.requestAd().then(function(t) {
